    ...
    SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults()) // Enable CORS
            .authorizeHttpRequests((requests) -> requests.requestMatchers(HttpMethod.GET, "/files/**").permitAll()
                                                         ...
                                                         .requestMatchers(HttpMethod.GET, "/api/v*/country/all")
                                                         .permitAll().requestMatchers("/api/v*/country/**")
                                                         ...
                                                         .permitAll()
                                                         .requestMatchers(HttpMethod.GET, "/api/v*/industry/all")
                                                         ...
                                                         .hasRole(AppUserType.ADMIN.name())
                                                         .requestMatchers(HttpMethod.GET, "/api/v*/color/all")
                                                         .permitAll().requestMatchers("/api/v*/color/**")
                                                         .hasRole(AppUserType.ADMIN.name())
                                                         .requestMatchers(HttpMethod.GET, "/api/v*/size/all")
                                                         .permitAll().requestMatchers("/api/v*/size/**")
                                                         .hasRole(AppUserType.ADMIN.name())
                                                         ...
                                                         .permitAll()
                                                         .requestMatchers(HttpMethod.GET, "/api/v*/material/all")
                                                         ...
                                                         .requestMatchers("/api/v*/company/**").permitAll()
